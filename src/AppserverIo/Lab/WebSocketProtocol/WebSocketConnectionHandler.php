...
/**
 * AppserverIo\Lab\WebSocketProtocol\WebSocketConnectionHandler
 *
 * NOTICE OF LICENSE
 *
...
class WebSocketConnectionHandler implements MessageComponentInterface
{
     ...
     * @throws \AppserverIo\Lab\WebSocketProtocol\BadRequestException Is thrown if no application can be found for the passed application name
     */
     ...
     *
     * @return \AppserverIo\Lab\WebSocketProtocol\WebSocketConnectionHandler The handler itself
     */
